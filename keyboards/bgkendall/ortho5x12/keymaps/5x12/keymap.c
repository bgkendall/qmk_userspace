...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    (
        CK_TONL,     KC_1,       KC_2,       KC_3,       KC_4,       KC_5,       KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_EQL,
        ...
        KC_LCTL,     KC_LALT,    KC_LGUI, MO(KL_FN),     KC_DEL,     KC_SPC,     KC_ENT,     KC_BSPC, TT(KL_NP),     KC_LEFT,    KC_DOWN,    KC_RGHT
    ),
    ...
    (
        ...
        KC_LSFT,     KC_UP,      KC_P0,      KC_PDOT,    XXXXXXX,    XXXXXXX,    KC_P1,      KC_P2,      KC_P3,      KC_PDOT,    _______,    _______,
        KC_LEFT,     KC_DOWN,    KC_RGHT, MO(KL_DEF),    KC_BSPC,    _______,    KC_PENT,    KC_P0,   TO(KL_DEF),    _______,    _______,    _______
    ),

    [KL_FN] = LAYOUT_ortho_5x12
    (
        KC_END,      KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_NOEQ,    KC_PLMI,    KC_LCBR,    KC_RCBR,    _______,
        ...
        _______,     KC_RALT,    _______,    _______,  G(KC_SPC),    _______,    KC_PENT,    _______, TT(KL_META),   KC_HOME,    KC_PGDN,    KC_END
    ),
    ...
    (
        ...
        XXXXXXX,     XXXXXXX,    XXXXXXX, TO(KL_DEF),    RGB_TOG,    RGB_TOG,    RGB_TOG,    RGB_TOG, TO(KL_DEF),    RGB_HUD,    RGB_SAD,    RGB_HUI
    )
};
